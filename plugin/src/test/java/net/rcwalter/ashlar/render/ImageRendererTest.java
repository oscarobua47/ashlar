...
package net.rcwalter.ashlar.render;
 ...
 * net.rcwalter.ashlar.engine.MapColorResolver}'s Bukkit-dependent map
 * color lookup is stood in for here by hand-picked ARGB ints, exactly as
 * {@code RenderHandler} would pass in after {@link
 * net.rcwalter.ashlar.engine.RenderTask} resolves them on the main
 * thread.
 */
