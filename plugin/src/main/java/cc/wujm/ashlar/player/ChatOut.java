 ...
 * message is a final reply (extracted from {@link cc.wujm.ashlar.handler.SendMessageHandler},
 * docs/private/prompts/step8b-prompt.md, so {@link cc.wujm.ashlar.agent.AgentService} can
