...
public record PluginConfig(
     ...
     * {@link cc.wujm.ashlar.AshlarPlugin#onEnable}; daily limits and the cooldown still apply
    ...
    public record AgentConfig(Mode mode, int cooldownSeconds, int maxMessageLength, boolean echoToMonitors,
         ...
         * slash; {@code "/chat/completions"} is appended by {@link cc.wujm.ashlar.agent.ModelClient}.
         */
